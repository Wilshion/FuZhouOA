package com.wilshion.common.widgets;
...
/**
 * Created by Wilshion on 2017/7/24 15:24.
 * [description : 带删除功能的 edittext]
 * [version : 1.0]
 */
public class UIEditText extends EditText implements View.OnFocusChangeListener,TextWatcher {
    /**
     * 删除按钮的引用
     */
    ...
    private void init() {
        ...
        if (mClearDrawable == null) {
            ...
            mClearDrawable = getResources().getDrawable(R.drawable.delete_40);
        }
